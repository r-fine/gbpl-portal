...
DEPARTMENTS = (
    ("ALL", "All"),
    ("Operation", "Operation"),
    ("Design & Business Development", "Design & Business Development"),
...
DESIGNATION = (
    ...
    ("Trainee Merchandiser", "Trainee Merchandiser"),
    ("Senior Merchandiser", "Senior Merchandiser"),
    ("Assistant Merchandiser officer", "Assistant Merchandiser officer"),
)
...
class User(AbstractUser):
    ...
    department = models.CharField(
        _("Department"), choices=DEPARTMENTS, max_length=50, null=True
    )
    designation = models.CharField(
        _("Designation"), choices=DESIGNATION, max_length=50, null=True
    )
